...
/**
 * Overlay
 * - Takes up the entire screen (inset-0)
 * - Slightly darkens the background (bg-black/80)
...
/**
 * Content
 * - Centered by parent overlay’s flex
 * - Rounded, shadowed white container
 ...
 * - Keep these simple, flexible, and composable
 */
const DialogHeader = ({
  className,
  ...props
